...
# gem 'shikashi', path: '../shikashi'   # A ruby sandbox
# gem 'shikashi', github: 'TotalVerb/shikashi', branch: 'unsafe' # A ruby sandbox
gem 'shikashi', github: 'daanforever/shikashi', branch: 'experimental' # A ruby sandbox
